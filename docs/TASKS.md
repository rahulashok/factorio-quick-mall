...
| 17  | UI window width should be constant (currently expands/contracts to the longest row)                                                                                                                                          | UX                   | Low      | 🟢 Done                       |
...
- **Status:** 🟢 Done — verified in-game 2026-07-13 (window width is stable and shows all 10 icon columns without clipping).
